...
public class DeptInfoWithEmpController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static Log log = LogFactory.getLog(DeptInfoWithEmpController.class);
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeptInfoWithEmpController() {
        super();
